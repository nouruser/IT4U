          ...
          <ul class="mt-6">
            ...
            <span
              ...
              >
                ...
                <span class="ml-4" style="color: #f4b328;">Dashboard</span>
              </a>
            </li>
          </ul>
          <ul>
            ...
            <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
              ...
              >
                <div
                  ...
                  style="background-color: #f4b328;"
                >
                  <svg class="w-5 h-5" fill="#1e429f" viewBox="0 0 20 20">
                    <path
                ...
                <div>
                  ...
                  >  
                  <?php require_once '../dao/dao-utilisateur.php';
              ...
              >
                <div
                  class="p-3 mr-4 rounded-full dark:text-green-100 dark:bg-green-500"
                  style="background-color: #f4b328;"
                >
                  <svg class="w-5 h-5" fill="#1e429f" viewBox="0 0 20 20">
                    <path
                ...
                <div>
                  ...
                  <p
                    class="text-lg font-semibold text-gray-700 dark:text-gray-200"
                  >
                  <?php require_once '../dao/dao-formation.php';
                    $db=new DaoFormation();
                    echo $db->sum_formation();
                  ?>
                  </p>
                </div>
              </div>
              ...
              >
                ...
                <div>
                  <p
                    class="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400"
                  >
                    Total des formateurss
                  </p>
                  <p
                    class="text-lg font-semibold text-gray-700 dark:text-gray-200"
                  >  
                  <?php require_once '../dao/dao-formateur.php';
                    $db=new DaoFormateur();
                    echo $db->sum_formateur();
                  ?>
                  </p>
                </div>
              </div>
              ...
              >
                ...
                <div>
                  ...
                  <p
                    class="text-lg font-semibold text-gray-700 dark:text-gray-200"
                  >
                  <?php require_once '../dao/dao-facture.php';
                    $db=new DaoFacture();
                    echo $db->sum_facture();
                  ?>
                  </p>
