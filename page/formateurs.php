...
?>
<?php require '../dao/dao-formateur.php'; ?>
<?php 
    $db=new DaoFormateur(); 
    $stmt = $db->recupererFormateurs();
?>
<!DOCTYPE html>
          ...
          <li class="relative px-6 py-3">
            ...
            <span
              ...
              <svg 
                ...
                <span class="ml-4" style="color: #f4b328;">Formateurs</span>
              </a>
            </li>   
            <div class="px-6 my-6">
                ...
                <div class="modal-dialog relative w-auto pointer-events-none">
                  <div
                    ...
                    <div
                      ...
                      <h5 class="text-xl font-medium leading-normal text-gray-800" id="exampleModalLabel">Ajouter formateur</h5>
                      <button type="button"
                        class="btn-close box-content w-4 h-4 p-1 text-black border-none rounded-none opacity-50 focus:shadow-none focus:outline-none focus:opacity-100 hover:text-black hover:opacity-75 hover:no-underline"
                        data-bs-dismiss="modal" aria-label="Close"></button>
                      </div>
                      <div class="modal-body relative p-4">
                        <form method="post" action=" ../controller/formateur-controller.php?action=add">
                                    ...
                                    <div class="  items-center justify-center md:w-1">        
                                        ...
                                        <div >
                                            ...
                                            <div class="position-number" class="block mt-4  ">
                                                ...
                                                <input id="tel" type="tel" name="tel" pattern="[0-9]{10}" 
                                                class="block w-full mt-1  dark:border-gray-600 dark:bg-gray-700 focus:border-blue-400 focus:outline-none focus:shadow-outline-blue dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                                type="tel" required
                                                />
                                            </label>
                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                      ...
                      <div class="flex items-center  text-sm">
                        ...
                        <form method="post" action=" ../controller/formateur-controller.php?action=update">
                          ...
                          <input name="numFor2" type="hidden" value="<?php echo $st['idFormateur'];?>" />
                              ...
                              <div class="modal-dialog relative `w-auto `pointer-events-none">
                                <div class="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white bg-clip-padding rounded-md outline-none text-current">
                                  <div class="modal-header flex flex-shrink-0 items-center justify-between p-4 border-b border-gray-200 rounded-t-md">
                                    <h5 class="text-xl font-medium leading-normal text-gray-800" id="exaLabel"> <input name="numFor2" type="" value="Modifier formateur"></h5>
                                                      ...
                                                      <div class="flex flex-1">
                                                          ...
                                                          <div class="position-number" class="block mt-4 ">
                                                            <label class="block mt-4 mr-2">
                                                              <span class="text-gray-700 dark:text-gray-400">nom</span>
                                                              <input name="nom" id="nom" value="<?php echo $st['nom'];?>"
                                                                class="block w-full mt-1  dark:border-gray-600 dark:bg-gray-700 focus:border-blue-400 focus:outline-none focus:shadow-outline-blue dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                                              required/>
                                                            </label>
                                                          </div>
                            ...
                            <form method="POST" action="../controller/formateur-controller.php?action=delete">
                              <input name="numFor" type="hidden" value="<?php echo $st['idFormateur'];?>" />
                                  <button
                                      class="h-8 w-8"
