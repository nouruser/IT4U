<button class="h-8 w-8"
    aria-label="Edit" data-bs-toggle="modal" style="color: blue; margin-right: 0rem; padding: 0rem; padding-left: 1rem;" data-bs-target="#exa">
...
<div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto"
          ...
          <div
                    ...
                    <div
                      ...
                      <h5 class="text-xl font-medium leading-normal text-gray-800" id="exaLabel">Modifier un Client</h5>
                      <button type="button"
                        class="btn-close box-content w-4 h-4 p-1 text-black border-none rounded-none opacity-50 focus:shadow-none focus:outline-none focus:opacity-100 hover:text-black hover:opacity-75 hover:no-underline"
                        data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body relative p-4">
<form method="post" action=" ../controller/utilisateur-controller.php?action=update">
...
<button type="button" class="px-6
    ...
    <input name="toto" type="hidden" value="<?php echo $st['email'];?>" >
